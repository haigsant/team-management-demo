...
.PHONY: help start stop restart build logs clean test-running-backend migrate shell django-shell create-superuser frontend
...
help:
	...
	@echo "  ${YELLOW}make test-running-backend${NC}  - Run backend tests"
	@echo ""
